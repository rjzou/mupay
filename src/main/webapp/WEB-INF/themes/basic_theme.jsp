...
<head>
	...
	<!-- CSS -->
	 <!-- Bootstrap core CSS -->
	<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css?Ver=20150831">
	<link href="${ctx}/resources/css/font-awesome.min.css?Ver=20150831" rel="stylesheet" type="text/css">
	<link href="${ctx}/resources/css/main.css?Ver=20150831" rel="stylesheet" type="text/css">
	<link href="${ctx}/resources/css/my-custom-styles.css?Ver=20150831" rel="stylesheet" type="text/css">

	<!--[if lte IE 9]>
		<link href="${ctx}/resources/css/main-ie.css" rel="stylesheet" type="text/css"/>
		<link href="${ctx}/resources/css/main-ie-part2.css" rel="stylesheet" type="text/css"/>
	<![endif]-->

	<!-- CSS for demo style switcher. you can remove this -->
	<link href="${ctx}/resources/css/style-switcher.css?Ver=20150831" rel="stylesheet" type="text/css">
	<!-- Fav and touch icons -->
	...
	<script type="text/javascript" src="//cdn.bootcss.com/jquery/2.1.4/jquery.min.js?Ver=20150831"></script>
	<script type="text/javascript" src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/js/bootstrap.min.js?Ver=20150831"></script>
	...
	<div class="del-style-switcher">
		...
		<form>
			<section class="del-section del-section-skin">
				...
				<ul>
					<li><a href="#" title="Slate Gray" class="switch-skin slategray" data-skin="${ctx}/resources/css/skins/slategray.css?Ver=20150831">Slate Gray</a></li>
					<li><a href="#" title="Dark Blue" class="switch-skin darkblue" data-skin="${ctx}/resources/css/skins/darkblue.css?Ver=20150831">Dark Blue</a></li>
					<li><a href="#" title="Dark Brown" class="switch-skin darkbrown" data-skin="${ctx}/resources/css/skins/darkbrown.css?Ver=20150831">Dark Brown</a></li>
					<li><a href="#" title="Light Green" class="switch-skin lightgreen" data-skin="${ctx}/resources/css/skins/lightgreen.css?Ver=20150831">Light Green</a></li>
					<li><a href="#" title="Orange" class="switch-skin orange" data-skin="${ctx}/resources/css/skins/orange.css?Ver=20150831">Orange</a></li>
					<li><a href="#" title="Red" class="switch-skin red" data-skin="${ctx}/resources/css/skins/red.css?Ver=20150831">Red</a></li>
					<li><a href="#" title="Teal" class="switch-skin teal" data-skin="${ctx}/resources/css/skins/teal.css?Ver=20150831">Teal</a></li>
					<li><a href="#" title="Yellow" class="switch-skin yellow" data-skin="${ctx}/resources/css/skins/yellow.css?Ver=20150831">Yellow</a></li>
				</ul>
				<button type="button" class="switch-skin-full fulldark" data-skin="${ctx}/resources/css/skins/fulldark.css?Ver=20150831">Full Dark</button>
				<button type="button" class="switch-skin-full fullbright" data-skin="${ctx}/resources/css/skins/fullbright.css?Ver=20150831">Full Bright</button>
			</section>
			...
			<p><a href="#" title="Reset Style" class="del-reset-style">Reset Style</a></p>
				  <p>在住<span class="badge element-bg-color-seagreen"> ${params.full_room_count}</span>间 &nbsp;&nbsp; 空房<span class="badge element-bg-color-green">${params.empty_room_count}</span>间</p>
				  <p>今天入住<span class="badge element-bg-color-blue">${params.today_checkin_room_count}</span>间 &nbsp;&nbsp; 今天退房<span class="badge element-bg-color-orange">${params.today_checkout_room_count}</span>间</p>
		</form>
	</div>
	<!-- END STYLE SWITCHER -->

	<!-- Javascript -->
	<script src="${ctx}/resources/js/modernizr.js?Ver=20150831"></script>
	<script src="//cdn.bootcss.com/bootstrap-tour/0.10.1/js/bootstrap-tour.js?Ver=20150831"></script>
	<script src="${ctx}/resources/js/king-common.js?Ver=20150831"></script>
	<script src="${ctx}/resources/js/deliswitch.js?Ver=20150831"></script>
	<script src="${ctx}/resources/js/jquery.easypiechart.min.js?Ver=20150831"></script>
	<script src="${ctx}/resources/js/raphael-2.1.0.min.js?Ver=20150831"></script>
	<script src="//cdn.bootcss.com/flot/0.8.3/jquery.flot.min.js?Ver=20150831"></script>
	<script src="//cdn.bootcss.com/flot/0.8.3/jquery.flot.resize.min.js?Ver=20150831"></script>
	<script src="//cdn.bootcss.com/flot/0.8.3/jquery.flot.time.min.js?Ver=20150831"></script>
	<script src="//cdn.bootcss.com/flot/0.8.3/jquery.flot.pie.min.js?Ver=20150831"></script>
	<script src="//cdn.bootcss.com/flot.tooltip/0.8.5/jquery.flot.tooltip.min.js?Ver=20150831"></script>
	<script src="${ctx}/resources/js/jquery.sparkline.min.js?Ver=20150831"></script>
	<script src="https://cdn.datatables.net/1.10.8/js/jquery.dataTables.min.js?Ver=20150831"></script>
	<script src="${ctx}/resources/js/dataTables.bootstrap.js?Ver=20150831"></script>
	<script src="${ctx}/resources/js/jquery.mapael.js?Ver=20150831"></script>
	<script src="${ctx}/resources/js/usa_states.js?Ver=20150831"></script>
	<script src="${ctx}/resources/js/king-chart-stat.js?Ver=20150831"></script>
	<script src="${ctx}/resources/js/king-table.js?Ver=20150831"></script>
	<script src="${ctx}/resources/js/king-components.js?Ver=20150831"></script>
</body>
